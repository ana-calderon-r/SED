...
st.markdown(
    ...
    <div style="text-align: center;">
        ...
        <h1 style="margin-top: 8px; color: #2F56A6;">Visualización y estimación de Subestaciones de Distribución</h1>
    </div>
    """,
...
try:
    ...
    st.info(f"Intervalo de confianza 95% - Voltaje: [{V_estimado_inf:.2f}, {V_estimado_sup:.2f}] V")
...
# Mañana
with col4:
    st.metric(label="Maniana / Media", value=f"{ratio_maniana:.2f}")
    st.progress(min(ratio_maniana/2, 1.0))
